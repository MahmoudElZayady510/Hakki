...
bool _favorite = true;
String firstChapter = 'وهذا التحول التدريجي الذي يطرأ على القانون، الذي كان في الماضي المعبِر عن السيادة الأحادية الأبعاد للكِيان السياسي، يصبح اليومَ مجردَ تطورٍ عملي يحكم قطاعات النشاط البشري على أساس وظيفي، ويقضي على الاستقلال الذاتي للسياسة التي تفقد أسسها المعنوية والفلسفية.';
class _BookDetailsState extends State<BookDetails> with TickerProviderStateMixin {
